 ...
 **/
 void test_RemoveNode_after_remove_rotate_right(void){
     ...
     TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node40);
     TEST_ASSERT_EQUAL_INTEGER_NODE(&node20,&node40,0,&node30);
 }
 /**
 ---------------------------------remove 50------------------------------
 *       40(-1)                            40 (-2)                                  30 (1)
 ...
 **/
 void test_RemoveNode_after_remove_rotate_right_condition2(void){
     ...
     TEST_ASSERT_EQUAL_PTR(&node30,root);
     TEST_ASSERT_EQUAL_INTEGER_NODE(&node35,NULL,-1,&node40);
     TEST_ASSERT_EQUAL_INTEGER_NODE(&node20,&node40,1,&node30);
 }
 /**
 ...
 **/
 void test_remove_given_a_avltree_need_rotateLeftRight_after_remove_condition1_expect_balance(void){
      ...
      TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node45);
      TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node70);
      TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node95);
      TEST_ASSERT_EQUAL_INTEGER_NODE(&node50,&node90,0,&node60);
      TEST_ASSERT_EQUAL_INTEGER_NODE(&node45,NULL,-1,&node50);
      TEST_ASSERT_EQUAL_INTEGER_NODE(&node70,&node95,0,&node90);
 }
 /**
 ---------------------------------remove 100       &           rotateLeftRight--------------------------------
 *           90(-1)                            90 (-2)                                        60 (0)
 ...
 **/
 void test_remove_given_a_avltree_need_rotateLeftRight_after_remove_condition2_expect_balance(void){
      ...
      TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node95);
      TEST_ASSERT_EQUAL_INTEGER_NODE(&node50,&node90,0,&node60);
      TEST_ASSERT_EQUAL_INTEGER_NODE(&node45,&node55,0,&node50);
      TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,&node95,1,&node90);
 ...
 **/
 void test_remove_rotateleft1(void){
     ...
     avlRemoveInteger(&root,30);
     TEST_ASSERT_EQUAL_PTR(&node50,root);
     TEST_ASSERT_EQUAL_INTEGER_NODE(&node40,&node100,0,&node50);
     TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node40);
     TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node100);
 ...
 **/
 void test_remove_rotateleft2(void){
     ...
     avlRemoveInteger(&root,30);
     TEST_ASSERT_EQUAL_PTR(&node50,root);
     TEST_ASSERT_EQUAL_INTEGER_NODE(&node40,&node100,-1,&node50);
 ...
 **/
 ...
 void test_remove_given_Avl_tree_remove_15_then_rotaterightleft_condition1_(void){
      ...
      TEST_ASSERT_EQUAL_PTR(&node40,root);
      TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node20);
      TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node35);
      TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node100);
      TEST_ASSERT_EQUAL_INTEGER_NODE(&node30,&node50,0,&node40);
      TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,&node100,1,&node50);
      TEST_ASSERT_EQUAL_INTEGER_NODE(&node20,&node35,0,&node30);
 }
 /**
 ---------------------------------remove 15 and rotateLeft---------------------------------
 *        30 (1)                            30 (2)                                   40
 ...
 **/
 void test_remove_given_Avl_tree_remove_15_then_rotaterightleft_condition2_(void){
      ...
      TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node100);
      TEST_ASSERT_EQUAL_INTEGER_NODE(&node30,&node50,0,&node40);
      TEST_ASSERT_EQUAL_INTEGER_NODE(&node45,&node100,0,&node50);
      TEST_ASSERT_EQUAL_INTEGER_NODE(&node20,&node35,0,&node30);
 }
 /**
 ---------------------------------remove 15 and rotateLeft---------------------------------
 ...
 **/
 void test_remove_given_Avl_tree_remove_15_then_rotaterightleft_condition3_(void){
      ...
      TEST_ASSERT_EQUAL_INTEGER_NODE(&node30,&node50,0,&node40);
      TEST_ASSERT_EQUAL_INTEGER_NODE(&node45,&node100,0,&node50);
      TEST_ASSERT_EQUAL_INTEGER_NODE(&node20,NULL,-1,&node30);
 }
 /**
 ---------------------------------------remove 60----------------------------------------
 *        60                        80 (0)
 ...
 **/
 ...
 void test_remove_given_Avl_tree_remove_15_then_rotaterightleft_condition3(void){
   ...
   TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node40);
   TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node100);
   TEST_ASSERT_EQUAL_INTEGER_NODE(&node40,&node100,0,&node80);
 }
 ...
 **/
 ...
 void test_remove_given_Avl_tree_remove_60(void){
   ...
   TEST_ASSERT_EQUAL_INTEGER_NODE(&node40,&node90,0,&node75);
   TEST_ASSERT_EQUAL_INTEGER_NODE(&node10,NULL,-1,&node40);
 ...
 **/
 void test_RemoveNode_test5(void){
   ...
   avlRemoveInteger(&root,30);
   TEST_ASSERT_EQUAL_PTR(&node40,root);
   TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,&node50,1,&node40);
 }
 /**
 ---------------------------------remove 30------------------------------
 *       40(1)                           45 (0)
 ...
 **/
 void test_RemoveNode_test6(void){
   ...
   avlRemoveInteger(&root,40);
   TEST_ASSERT_EQUAL_PTR(&node45,root);
   TEST_ASSERT_EQUAL_INTEGER_NODE(&node30,&node50,0,&node45);
 }
 /**
 ---------------------------------------remove 60----------------------------------------
 *        60 (1)                           75 (0)
 ...
 **/
 ...
 void test_remove_given_Avl_tree_remove_60_test1(void){
   ...
   avlRemoveInteger(&root,60);
   TEST_ASSERT_EQUAL_PTR(&node75,root);
   TEST_ASSERT_EQUAL_INTEGER_NODE(&node40,&node90,1,&node75);
   TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node40);
   TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,&node100,1,&node90);
   TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node100);
 ...
 **/
 ...
 void test_remove_test8(void){
   ...
   TEST_ASSERT_EQUAL_PTR(&node60,root);
   TEST_ASSERT_EQUAL_INTEGER_NODE(&node50,&node90,0,&node60);
   TEST_ASSERT_EQUAL_INTEGER_NODE(&node20,&node55,0,&node50);
   TEST_ASSERT_EQUAL_INTEGER_NODE(&node75,&node100,0,&node90);
   TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node100);
   TEST_ASSERT_EQUAL_INTEGER_NODE(NULL,NULL,0,&node75);
 }
